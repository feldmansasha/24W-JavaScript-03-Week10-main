...
class Coffee{
    ...
    let tonyCoffee=new Coffee("medium", false);
    let maxCoffee=new Coffee("large", true);
    let mattCoffee=new Coffee("small", false);
    ...
    class Latte extends Coffee{
        ...
        latteDesc(){
            alert(`A ${this.size} latte with ${this.milkType} milk.`);
        }
    }
    /* STEP 6: Create a new instance of the Latte object */
    let johnCoffee=new Latte("medium", false, "2%");
